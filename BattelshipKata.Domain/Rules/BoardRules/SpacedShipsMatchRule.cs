...
{
    public class SpacedShipsMatchRule : IMatchRule
    {
        private readonly Board board;
        private readonly IEnumerable<Ship> ships;

        public SpacedShipsMatchRule(Board board, IEnumerable<Ship> ships)
        {
            this.board = board;
            this.ships = ships;
        }
        ...
        {
            return ships.Where(sh => sh.BoundingBox.Contains(point));
        }
        public bool IsMatch()
        {
